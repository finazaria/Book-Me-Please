"""
Django settings for bookmeplease project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-#^4i$fkorzyyy*!&ty%)b2&w_g3zb+l!!+v$&a!)cxyd^@o0xm')
...
ROOT_URLCONF = 'bookmeplease.urls'
